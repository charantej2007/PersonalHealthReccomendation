...
import { requestSignupOtp, verifySignupOtp } from '../services/backendService';
...
export function SignUpOtpScreen() {
  ...
  const state = (location.state as SignUpOtpState | null) ?? null;
  ...
  return (
    <div className="h-full bg-white overflow-y-auto">
      <div className="px-8 py-8 pb-24">
        ...
        <h1 className="text-3xl font-semibold text-gray-800 mb-2">Verify Email</h1>
